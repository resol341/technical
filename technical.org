...
*** Dilute 1:200 in media with 0.1% FBS and use as 1000x stock.
...
*** clean the deflection plate, wipe down everything with Ethanol
...
*** Store the cleaning chip back to the bag
*** Load the sorting chip with 100u mark on top facing you.
*** Select standard configuration
*** Sheath Filter Debubble
*** Run Automatic Calibration
    Note: always select sort calibration if sorting
*** Load 1 ml or more of undiluted, automatic setup beads in a sample tube
    Note: automatic setup beads is in cold room. Vortex to mix, should be blue in color.
*** Always select “Targeted”.
...
| NaCl        |           113 |           4.52 |           1.25 |
| KCl         |             5 |              2 |          0.125 |
| NaH2PO4     |           0.5 |            0.5 |           0.05 |
| HEPES       |            10 |              1 |            0.5 |
| EDTA        |             5 |            0.5 |            0.5 |
|-------------+---------------+----------------+----------------|
| Component   | TargConc (mM) |             MW |    Weight (mg) |
|-------------+---------------+----------------+----------------|
| Glucose     |            10 |         180.16 |          90.08 |
| BDM         |            10 |         101.11 |         50.555 |
| Taurine     |            10 |         125.15 |         62.575 |
|-------------+---------------+----------------+----------------|
| TargVol(mL) |            50 |            H2O |         41.975 |
| Ph to 7.8   |        approx |        1N NaOH |           0.25 |
#+TBLFM: $4=@11$2 - vsum(@2..@6) - @12$4::@2$4=(@11$2*@2$2)/(@2$3*1000)::@3$4=(@11$2*@3$2)/(@3$3*1000)::@4$4=(@11$2*@4$2)/(@4$3*1000)::@5$4=(@11$2*@5$2)/(@5$3*1000)::@6$4=(@11$2*@6$2)/(@6$3*1000)::@8$4=(@11$2 / 1000) * @8$2 * @8$3::@9$4=(@11$2 / 1000) * @9$2 * @9$3::@10$4=(@11$2 / 1000) * @10$2 * @10$3::@12$4=@11$2/200

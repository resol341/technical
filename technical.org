...
**** About 12 mL needed per sample
*** 10 µM cisplatin (2X concentration)
**** Prepare a working solution of 10 µM cisplatin (2X concentration) by diluting the Cell-ID Cisplatin in Maxpar Cell Staining Buffer. For example, add 2 µL of 5 mM stock to 1 mL of Maxpar Cell Staining Buffer.
...
**** Resuspend the pellet in 49 uL of Maxpar Cell Staining Buffer for surface staining
*** Stain Cells With Surface Antibodies
**** Add 1 uL of FC block and incubate at RT for 10 min
**** Add 50 uL of the 2X surface antibody cocktail to each tube so the total staining volume is 100 uL
...
| Elastase suspension (uL) |             0.75 |   1425.8555 |
| Volume (mL)              |               50 |             |
...
**** 293T stocks are in liquid nitrogen tank # Rack3 C
** Day 2

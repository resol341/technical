...
| Component                | TargConc (mg/mL) | Weight (mg) |
|--------------------------+------------------+-------------|
| Collagenase 2            |              3.2 |        176. |
| Soybean Trysin Inhibitor |              0.2 |           a |
| Elastase suspension (uL) |             0.75 |   1568.4411 |
| Volume (mL)              |               55 |             |
...
*** Plate target cells for infection the following day**** AdvSca1-SM cells 1*10^6 cells/10cm dish
** Day 4

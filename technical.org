...
| Taurine     |            10 |         125.15 |          250.3 |
|-------------+---------------+----------------+----------------|
| TargVol(mL) |           200 |            H2O |         192.88 |
| Ph to 7.8   |        approx |        1N NaOH |              1 |
#+TBLFM: $4=@11$2 - vsum(@2..@6) - @12$4::@2$4=(@11$2*@2$2)/(@2$3*1000)::@3$4=(@11$2*@3$2)/(@3$3*1000)::@4$4=(@11$2*@4$2)/(@4$3*1000)::@5$4=(@11$2*@5$2)/(@5$3*1000)::@6$4=(@11$2*@6$2)/(@6$3*1000)::@8$4=(@11$2 / 1000) * @8$2 * @8$3::@9$4=(@11$2 / 1000) * @9$2 * @9$3::@10$4=(@11$2 / 1000) * @10$2 * @10$3::@12$4=@11$2/200
   3. Collagenase buffer (10 mL per mouse) in perfusion buffer. Prepare right before procedure, warm to 37 degree
| Component                | TargConc (mg/mL) | Weight (mg) |
|--------------------------+------------------+-------------|
| Collagenase 2            |              3.2 |         48. |
| Soybean Trysin Inhibitor |              0.2 |          3. |
| Elastase suspension (uL) |             0.75 |   427.75665 |
| Volume (mL)              |               15 |             |
...
*** Transfer the aqueous phase to a fresh tube and precipitate the RNA by mixing with 0.5 ml of isopropanol for every ml of TRIzol used initially. Incubate at room temperature for 10’. Mix the tube by inverting and centrifuge for 10’ at 12, 000xg, at 4 degree.
...
*** Resuspend the RNA in 50 uL RNAase free MQ water. To completely redissolve the RNA pelet, incubate the tube at 60C for 10’ with occasional pipetting up and down in between.
*** DNase I treatment
**
